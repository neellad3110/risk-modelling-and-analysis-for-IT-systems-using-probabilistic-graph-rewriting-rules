...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="host-anon">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <edge from="n1" to="n1">
            <attr name="label">
                <string>type:Sales</string>
            </attr>
        </edge>
        <edge from="n2" to="n2">
            <attr name="label">
                <string>type:Engineering</string>
            </attr>
        </edge>
        <edge from="n2" to="n6">
            <attr name="label">
        ...
        <edge from="n24" to="n24">
            <attr name="label">
                <string>let:owner="user_EMP001"</string>
            </attr>
        </edge>
        <edge from="n24" to="n24">
            <attr name="label">
        ...
        <edge from="n25" to="n25">
            <attr name="label">
                <string>let:owner="user_EMP002"</string>
            </attr>
        </edge>
        <edge from="n26" to="n26">
            <attr name="label">
                <string>let:owner="user_EMP003"</string>
            </attr>
        </edge>
        <edge from="n26" to="n26">
            <attr name="label">
